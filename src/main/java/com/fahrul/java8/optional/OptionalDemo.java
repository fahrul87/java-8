package com.fahrul.java8.optional;
...
public class OptionalDemo {
	...
	public static Customer getCustomerByEmailId(String email) throws Exception {
		...
		return customers.stream().filter(customer -> customer.getEmail().equals(email)).findAny()
				.orElseThrow(() -> new Exception("no customer with this ID"));
	}

	public static void main(String[] args) throws Exception {

		Customer customer = new Customer(101, "fahrul", "fahrul@gmail.com", Arrays.asList("397937955", "21654725"));
		...
		System.out.println(emaOptional2.map(String::toUpperCase).orElseGet(() -> "default email..."));
